<?php $__env->startSection('title', 'Edit Data KK - Sistem Kependudukan'); ?>
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 800px;">
            ...
            <h1 class="mb-5 display-4">Formulir Edit Kartu Keluarga</h1>
        </div>
        ...
        <div class="row justify-content-center wow fadeIn" data-wow-delay="0.3s">
            <div class="col-lg-8">
                <div class="bg-light border border-primary rounded p-5">
                    ...
                    <form action="<?php echo e(route('keluarga.update', $keluarga->kk_id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="kk_nomor" id="kk_nomor" value="<?php echo e(old('kk_nomor', $keluarga->kk_nomor)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $warga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($w->warga_id); ?>" <?php echo e(old('kepala_keluarga_warga_id', $keluarga->kepala_keluarga_warga_id) == $w->warga_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              style="height: 100px" required><?php echo e(old('alamat', $keluarga->alamat)); ?></textarea>
                                    <label for="alamat">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="rt" id="rt" value="<?php echo e(old('rt', $keluarga->rt)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           name="rw" id="rw" value="<?php echo e(old('rw', $keluarga->rw)); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/keluarga/edit.blade.php ENDPATH**/ ?>