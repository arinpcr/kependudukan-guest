...
<?php $__env->startSection('title', 'Edit Anggota Keluarga - Sistem Kependudukan'); ?>
                ...
                <div class="bg-light border border-primary rounded p-5">
                    ...
                    <div class="card mb-4 border-primary">
                        <div class="card-header bg-primary text-white py-2">
                            <h6 class="mb-0">
                                <i class="fas fa-home me-2"></i>Kartu Keluarga: <?php echo e($anggota->keluarga->kk_nomor); ?>
                        ...
                        <div class="card-body py-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1 fw-bold"><?php echo e($anggota->warga->nama); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <small class="text-muted">No KTP:</small>
                                    <p class="mb-1 fw-bold"><?php echo e($anggota->warga->no_ktp); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <a href="<?php echo e(route('anggota-keluarga.index', $anggota->kk_id)); ?>" class="btn btn-secondary btn-sm mb-4">
                    ...
                    <form action="<?php echo e(route('anggota-keluarga.update', [$anggota->kk_id, $anggota->anggota_id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-light" 
                                           value="<?php echo e($anggota->warga->nama); ?> (<?php echo e($anggota->warga->no_ktp); ?>)" 
                                           disabled>
                                    <label>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $hubunganOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(old('hubungan', $anggota->hubungan) == $value ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="<?php echo e(route('anggota-keluarga.index', $anggota->kk_id)); ?>" class="btn btn-secondary me-md-2 px-4">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/anggota-keluarga/edit.blade.php ENDPATH**/ ?>