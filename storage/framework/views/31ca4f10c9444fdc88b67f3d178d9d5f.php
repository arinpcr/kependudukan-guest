<?php $__env->startSection('title', 'Data Warga - Sistem Kependudukan'); ?>
            ...
            <div class="col-12">
                <div class="bg-light border border-primary rounded p-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <a href="<?php echo e(route('warga.create')); ?>" class="btn btn-primary">
                            <i class="fas fa-user-plus me-2"></i>Tambah Warga Baru
                        </a>
                        
                        <div class="text-muted">
                            <i class="fas fa-users me-2 text-primary"></i>
                            Total Data: <strong><?php echo e($warga->total()); ?></strong>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <form action="<?php echo e(route('warga.index')); ?>" method="GET" id="searchForm">
                            ...
                            <form action="<?php echo e(route('warga.index')); ?>" method="GET" id="filterForm">
                                <?php if(request('search')): ?>
                    ...
                    <?php if(request('search') || request('jenis_kelamin') || request('sort')): ?>
                    <div class="alert alert-info alert-dismissible fade show mb-4" role="alert">
                        ...
                        <?php endif; ?>
                        <?php if(request('jenis_kelamin')): ?>
                            <span class="badge bg-success me-2">Gender: <?php echo e(request('jenis_kelamin') == 'L' ? 'Laki-laki' : 'Perempuan'); ?></span>
                        <?php endif; ?>
                        <a href="<?php echo e(route('warga.index')); ?>" class="btn btn-sm btn-outline-info ms-2">Hapus Filter</a>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php endif; ?>

                    <div class="row g-4">
                        <?php $__empty_1 = true; $__currentLoopData = $warga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-primary">
                                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0 text-truncate" style="max-width: 80%;">
                                        <i class="fas fa-user me-2"></i><?php echo e($item->nama); ?>

                                    </h6>
                                    <span class="badge bg-light text-dark">#<?php echo e($warga->firstItem() + $index); ?></span>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <p class="ms-4 mb-0"><?php echo e($item->no_nik); ?></p>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="ms-4">
                                            <small class="d-block text-muted">Agama: <?php echo e($item->agama); ?></small>
                                            <small class="d-block text-muted">Pekerjaan: <?php echo e($item->pekerjaan); ?></small>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer bg-transparent border-top-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="<?php echo e(route('warga.edit', $item)); ?>" 
                                        ...
                                        <form action="<?php echo e(route('warga.destroy', $item)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-12">
                            <div class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <a href="<?php echo e(route('warga.index')); ?>" class="btn btn-primary mt-2">
                    ...
                    <?php if($warga->hasPages()): ?>
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="text-muted small">
                            Menampilkan <?php echo e($warga->firstItem()); ?> sampai <?php echo e($warga->lastItem()); ?> dari <?php echo e($warga->total()); ?> data
                        </div>
                        <nav>
                            <?php echo e($warga->withQueryString()->links('pagination::bootstrap-5')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Amel_2SIB\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/warga/index.blade.php ENDPATH**/ ?>