<?php $__env->startSection('title', 'Edit Data Warga - Sistem Kependudukan'); ?>
        ...
        <div class="row justify-content-center wow fadeIn" data-wow-delay="0.3s">
            <div class="col-lg-8">
                <div class="bg-light border border-primary rounded p-5">
                    ...
                    <form action="<?php echo e(route('warga.update', $warga)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control <?php $__errorArgs = ['no_nik'];
...
unset($__errorArgs, $__bag); ?>" 
                                           name="no_nik" id="no_nik" value="<?php echo e(old('no_nik', $warga->no_nik)); ?>" 
                                           placeholder="Nomor NIK" required>
                                    <label for="no_nik">
                                        <i class="fas fa-id-card me-2 text-primary"></i>Nomor NIK
                                    </label>
                                    <?php $__errorArgs = ['no_nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                                           name="nama" id="nama" value="<?php echo e(old('nama', $warga->nama)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="L" <?php echo e(old('jenis_kelamin', $warga->jenis_kelamin) == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                                        <option value="P" <?php echo e(old('jenis_kelamin', $warga->jenis_kelamin) == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="agama" id="agama" value="<?php echo e(old('agama', $warga->agama)); ?>" 
                                           placeholder="Agama">
                                    <label for="agama">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="pekerjaan" id="pekerjaan" value="<?php echo e(old('pekerjaan', $warga->pekerjaan)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           name="telp" id="telp" value="<?php echo e(old('telp', $warga->telp)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           name="email" id="email" value="<?php echo e(old('email', $warga->email)); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/warga/edit.blade.php ENDPATH**/ ?>