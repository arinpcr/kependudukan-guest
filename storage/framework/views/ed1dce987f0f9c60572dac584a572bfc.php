...
unset($__errorArgs, $__bag); ?>"
                           name="name" id="name" placeholder="Nama Lengkap" value="<?php echo e(old('name')); ?>" required autofocus>
                    <label for="name">
...
unset($__errorArgs, $__bag); ?>"
                           name="email" id="email" placeholder="name@example.com" value="<?php echo e(old('email')); ?>" required>
                    <label for="email">
