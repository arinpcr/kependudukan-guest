...
<?php $__env->startSection('title', 'Profile Saya - Sistem Kependudukan'); ?>
                ...
                <div class="card border-primary shadow-sm h-100 text-center p-4">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-primary rounded-pill">
    <i class="fas fa-edit me-2"></i>Edit Profile
</a>
                            <a href="<?php echo e(route('profile.password')); ?>" class="btn btn-outline-secondary rounded-pill">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="fs-5 text-dark border-bottom pb-2">
                                        <i class="fas fa-user me-2 text-primary"></i> <?php echo e($user->name); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="fs-5 text-dark border-bottom pb-2">
                                        <i class="fas fa-envelope me-2 text-primary"></i> <?php echo e($user->email); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="fs-5 text-dark border-bottom pb-2">
                                        <i class="fas fa-id-card me-2 text-primary"></i> <?php echo e($user->role); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted fst-italic">
                                        (<?php echo e(\Carbon\Carbon::parse($user->updated_at)->diffForHumans()); ?>)
                                    </small>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/profile.blade.php ENDPATH**/ ?>