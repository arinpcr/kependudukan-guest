<?php $__env->startSection('title', 'Tentang Kami - Sistem Kependudukan'); ?>
        ...
        <div class="col-lg-4 col-md-5 mb-4 mb-md-0 wow fadeInLeft" data-wow-delay="0.3s">
            <div class="dev-card mx-auto" style="max-width: 350px;">
                <div class="dev-img-wrapper">
                    <img src="<?php echo e(asset('assets-guest/img/foto-saya.jpg')); ?>" 
                         alt="Foto Pengembang"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 text-center">
                        <div class="p-3 bg-light rounded-3 border">
                            <img src="<?php echo e(asset('assets-guest/img/flow-kependudukan.png')); ?>" 
...
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/about.blade.php ENDPATH**/ ?>