...
<?php $__env->startSection('title', 'Data Semua Anggota Keluarga - Sistem Kependudukan'); ?>
            ...
            <div class="col-12">
                <div class="bg-light border border-primary rounded p-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <a href="<?php echo e(route('keluarga.index')); ?>" class="btn btn-secondary me-2">
                                <i class="fas fa-arrow-left me-2"></i>Kembali ke KK
                            </a>
                            <a href="<?php echo e(route('warga.index')); ?>" class="btn btn-outline-primary">
                        ...
                        <div class="text-muted">
                            ...
                            Total Data: <strong><?php echo e($anggota->total()); ?></strong>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <form action="<?php echo e(route('anggota-keluarga.all')); ?>" method="GET" id="searchForm">
                                        <div class="input-group">
                                            ...
                                            <a href="<?php echo e(route('anggota-keluarga.all')); ?>" class="btn btn-outline-secondary">
                            ...
                            <form action="<?php echo e(route('anggota-keluarga.all')); ?>" method="GET" id="filterForm">
                                <?php if(request('search')): ?>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="kk_id" id="filterKK" onchange="this.form.submit()">
                                            ...
                                            <?php $__currentLoopData = $keluargas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keluarga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($keluarga->kk_id); ?>" <?php echo e(request('kk_id') == $keluarga->kk_id ? 'selected' : ''); ?>>
                                                    <?php echo e($keluarga->kk_nomor); ?> - <?php echo e($keluarga->kepalaKeluarga->nama ?? ''); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="sort" id="sortBy" onchange="this.form.submit()">
                                            <option value="nama" <?php echo e(request('sort') == 'nama' ? 'selected' : ''); ?>>Nama A-Z</option>
                                            <option value="nama_desc" <?php echo e(request('sort') == 'nama_desc' ? 'selected' : ''); ?>>Nama Z-A</option>
                                            <option value="kk" <?php echo e(request('sort') == 'kk' ? 'selected' : ''); ?>>Nomor KK</option>
                    ...
                    <!-- Info Pencarian -->
                    <?php if(request('search') || request('kk_id') || request('hubungan') || request('sort')): ?>
                    <div class="alert alert-info alert-dismissible fade show mb-4" role="alert">
                        ...
                        <?php endif; ?>
                        <?php if(request('kk_id')): ?>
                            <?php
                                $selectedKK = $keluargas->where('kk_id', request('kk_id'))->first();
                            ?>
                            <span class="badge bg-success me-2">KK: <?php echo e($selectedKK->kk_nomor ?? request('kk_id')); ?></span>
                        <?php endif; ?>
                        <?php if(request('hubungan')): ?>
                            <span class="badge bg-warning me-2">Hubungan: <?php echo e($hubunganOptions[request('hubungan')] ?? request('hubungan')); ?></span>
                        <?php endif; ?>
                        <?php if(request('sort')): ?>
                            <span class="badge bg-info me-2">Urutan: 
                                <?php if(request('sort') == 'nama'): ?> Nama A-Z
                                <?php elseif(request('sort') == 'nama_desc'): ?> Nama Z-A
                                <?php elseif(request('sort') == 'kk'): ?> Nomor KK
                                <?php elseif(request('sort') == 'terbaru'): ?> Terbaru
                                <?php elseif(request('sort') == 'terlama'): ?> Terlama
                                <?php endif; ?>
                            </span>
                        <?php endif; ?>
                        <a href="<?php echo e(route('anggota-keluarga.all')); ?>" class="btn btn-sm btn-outline-info ms-2">Hapus Filter</a>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php endif; ?>
                            ...
                            <div class="card h-100 shadow-sm border-primary anggota-card">
                                <div class="card-header bg-primary text-white py-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">
                                            <i class="fas fa-user me-2"></i><?php echo e($item->warga->nama ?? 'Data warga tidak ditemukan'); ?>

                                        </h6>
                                        <?php if($item->hubungan == 'kepala_keluarga'): ?>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <small class="text-muted d-block">
                                            ...
                                            <strong>KK:</strong> <?php echo e($item->keluarga->kk_nomor ?? 'N/A'); ?>

                                        </small>
                                        <small class="text-muted">
                                            <i class="fas fa-user-tie me-2"></i>
                                            <?php echo e($item->keluarga->kepalaKeluarga->nama ?? 'Kepala KK Tidak Ditemukan'); ?>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span><?php echo e($item->warga->no_ktp ?? '-'); ?></span>
                                    </div>
                                    
                                    <div class="mb-2">
                                        <i class="fas fa-venus-mars me-2 text-muted"></i>
                                        <?php if(($item->warga->jenis_kelamin ?? '') == 'L'): ?>
                                            <span class="badge bg-info">Laki-laki</span>
                                        <?php elseif(($item->warga->jenis_kelamin ?? '') == 'P'): ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span class="badge bg-primary"><?php echo e($item->hubungan_label); ?></span>
                                    </div>
                                </div>
                                <div class="card-footer bg-transparent">
                                    <div class="btn-group w-100">
                                        <a href="<?php echo e(route('anggota-keluarga.show', ['keluarga' => $item->kk_id, 'anggota' => $item->anggota_id])); ?>" 
                                           class="btn btn-info btn-sm" 
                                           data-bs-toggle="tooltip" 
                                           title="Detail Anggota">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('anggota-keluarga.edit', ['keluarga' => $item->kk_id, 'anggota' => $item->anggota_id])); ?>" 
                                           class="btn btn-warning btn-sm" 
                                           data-bs-toggle="tooltip" 
                                           title="Edit Hubungan">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?php echo e(route('anggota-keluarga.index', $item->kk_id)); ?>" 
                            ...
                            <div class="card border-warning">
                                <div class="card-body text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <h4>
                                            <?php if(request('search') || request('kk_id') || request('hubungan')): ?>
                                        ...
                                        <?php if(request('search') || request('kk_id') || request('hubungan')): ?>
                                        <a href="<?php echo e(route('anggota-keluarga.all')); ?>" class="btn btn-primary mt-2">
                                            <i class="fas fa-refresh me-2"></i>Tampilkan Semua Data
                                        </a>
                                        <?php else: ?>
                                        <a href="<?php echo e(route('keluarga.create')); ?>" class="btn btn-primary mt-2">
                    ...
                    <div class="card mt-4 border-success">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col-md-3">
                                    <div class="text-primary fw-bold fs-4"><?php echo e($anggota->total()); ?></div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    ?>
                                    <div class="text-warning fw-bold fs-4"><?php echo e($kepalaKeluarga); ?></div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    ?>
                                    <div class="text-info fw-bold fs-4"><?php echo e($laki); ?></div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    ?>
                                    <div class="text-pink fw-bold fs-4"><?php echo e($perempuan); ?></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/anggota-keluarga/all.blade.php ENDPATH**/ ?>