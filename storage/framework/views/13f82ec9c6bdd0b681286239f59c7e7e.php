<?php $__env->startSection('title', 'Kependudukan'); ?>
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-7 col-md-12">
                ...
                <a href="<?php echo e(route('warga.index')); ?>" class="btn btn-primary px-4 py-3 px-md-5 me-4 btn-border-radius">Mulai Sekarang</a>
                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary px-4 py-3 px-md-5 btn-border-radius">Pelajari Lebih Lanjut</a>
            </div>
        ...
        <div class="testimonial-carousel owl-carousel wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative text-center">
                    ...
                    <div class="border-top border-primary mt-4 pt-3">
                        <h2 class="text-dark mb-2 display-4"><?php echo e($totalWarga ?? 0); ?></h2>
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative text-center">
                    ...
                    <div class="border-top border-primary mt-4 pt-3">
                        <h2 class="text-dark mb-2 display-4"><?php echo e($totalKK ?? 0); ?></h2>
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative text-center">
                    ...
                    <div class="border-top border-primary mt-4 pt-3">
                        <h2 class="text-dark mb-2 display-4"><?php echo e($totalKelahiran ?? 0); ?></h2>
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative text-center">
                    ...
                    <div class="border-top border-primary mt-4 pt-3">
                        <h2 class="text-dark mb-2 display-4"><?php echo e($totalKematian ?? 0); ?></h2>
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative text-center">
                    ...
                    <div class="border-top border-primary mt-4 pt-3">
                        <h2 class="text-dark mb-2 display-4"><?php echo e($totalPindah ?? 0); ?></h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 col-6 mb-4">
                            <div class="testimonial-item img-border-radius bg-white border border-primary p-4 h-100">
                                ...
                                <h5 class="text-dark mb-1 display-6"><?php echo e($totalLaki ?? 0); ?></h5>
                        ...
                        <div class="col-md-4 col-6 mb-4">
                            <div class="testimonial-item img-border-radius bg-white border border-primary p-4 h-100">
                                ...
                                <h5 class="text-dark mb-1 display-6"><?php echo e($totalPerempuan ?? 0); ?></h5>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Amel_2SIB\laragon-6.0-minimal\www\kependudukan-guest\resources\views/guest/dashboard.blade.php ENDPATH**/ ?>