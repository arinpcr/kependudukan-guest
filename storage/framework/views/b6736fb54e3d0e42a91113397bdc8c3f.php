...
<?php $__env->startSection('title', 'Edit Profile - Sistem Kependudukan'); ?>
            ...
            <div class="col-lg-8">
                <div class="card border-primary shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('profile')); ?>" class="btn btn-sm btn-light text-primary fw-bold">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light" value="<?php echo e($user->role); ?>" readonly disabled>
                                        <div class="form-text">Role tidak dapat diubah secara mandiri.</div>
                                    </div>

                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                                        <a href="<?php echo e(route('profile')); ?>" class="btn btn-secondary px-4">Batal</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\arin\laragon-6.0-minimal\www\kependudukan-guest\resources\views/pages/profile-edit.blade.php ENDPATH**/ ?>