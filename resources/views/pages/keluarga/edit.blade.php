...
@section('title', 'Edit Data KK - Sistem Kependudukan')
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('kk_nomor') is-invalid @enderror" 
                                           name="kk_nomor" id="kk_nomor" value="{{ old('kk_nomor', $keluarga->kk_nomor) }}" 
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select class="form-select @error('kepala_keluarga_warga_id') is-invalid @enderror" 
                                        ...
                                        @foreach ($warga as $w)
                                            <option value="{{ $w->warga_id }}" {{ old('kepala_keluarga_warga_id', $keluarga->kepala_keluarga_warga_id) == $w->warga_id ? 'selected' : '' }}>
                                                {{ $w->nama }} (KTP: {{ $w->no_ktp }})
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                              ...
                                              style="height: 100px" required>{{ old('alamat', $keluarga->alamat) }}</textarea>
                                    <label for="alamat">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('rt') is-invalid @enderror" 
                                           name="rt" id="rt" value="{{ old('rt', $keluarga->rt) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('rw') is-invalid @enderror" 
                                           name="rw" id="rw" value="{{ old('rw', $keluarga->rw) }}" 
