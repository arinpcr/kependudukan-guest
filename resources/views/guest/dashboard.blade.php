...
                <link href="assets-guest/lib/animate/animate.min.css" rel="stylesheet">
...
              _message_idx_1_rotation_0.1                     <p class="my-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, culpa qui officiis animi Lorem ipsum dolor sit amet, 
                                        consectetur adipisicing elit.</p>
                                    <a href="#" class="btn btn-primary text-white px-4 py-2 my-2 btn-border-radius">Read More</a>
                                </div>
                            </div>
...
                                    <img src="assets-guest/img/program-1.jpg" class="img-fluid w-100" alt="Image">
                                </div>
...
                                <img src="assets-guest/img/program-teacher.jpg" class="img-fluid rounded-circle p-2 border border-primary bg-white" alt="Image" style="width: 70px; height: 70px;">
                                <div class="ms-3">
...
                            </div>
                        </div>
A/B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="assets-guest/img/program-2.jpg" class="img-fluid w-100" alt="Image">
                                </div>
                  _message_idx_1_rotation_0.1
                        <div class="program-text bg-white px-4 pb-3">
                                <div class="program-text-inner">
...
A/B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
                            <div class="program-teacher d-flex align-items-center border-top border-primary bg-white px-4 py-3">
                                <img src="assets-guest/img/program-teacher.jpg" class="img-fluid rounded-circle p-2 border border-primary bg-white" alt="" style="width: 70px; height: 70px;">
                                <div class="ms-3">
                                    <h6 class="mb-0 text-primary">Mary Mordern</h6>
                                    <small>Arts Designer</small>
                          _message_idx_1_rotation_0.1
...
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="assets-guest/img/program-3.jpg" class="img-fluid w-100" alt="Image">
                                </div>
                                <div class="px-4 py-2 bg-primary text-white program-rate">$60.99</div>
                            </div>
                            <div class="program-text bg-white px-4 pb-3">
...
                                    <img src="assets-guest/img/event-1.jpg" class="img-fluid w-100 rounded-circle" alt="Image">
                                    <div class="event-overlay">
                                        <a href="assets-guest/img/event-1.jpg" data-lightbox="event-1"><i class="fas fa-search-plus text-white fa-2x"></i></a>
                                    </div>
                                </div>
...
                            <div class="events-inner position-relative">
                                <div class="events-img overflow-hidden rounded-circle position-relative">
                                    <img src="assets-guest/img/event-2.jpg" class="img-fluid w-100 rounded-circle" alt="Image">
                                    <div class="event-overlay">
                                        <a href="assets-guest/img/event-3.jpg" data-lightbox="event-1"><i class="fas fa-search-plus text-white fa-2x"></i></a>
                                    </div>
                                </div>
                                <div class="px-4 py-2 bg-secondary text-white text-center events-rate">29 Nov</div>
                                <div class="d-flex justify-content-between px-4 py-2 bg-secondary">
...
                            <div class="events-inner position-relative">
                                <div class="events-img overflow-hidden rounded-circle position-relative">
                                    <img src="assets-guest/img/event-3.jpg" class="img-fluid w-100 rounded-circle" alt="Image">
a-idx-1-start
                                    <div class="event-overlay">
                                        <a href="assets-guest/img/event-3.jpg" data-lightbox="event-1"><i class="fas fa-search-plus text-white fa-2x"></i></a>
                                    </div>
...
                                <img src="assets-guest/img/blog-1.jpg" class="img-fluid w-100" alt="Image">
                            </div>
...
                                    <img src="assets-guest/img/program-teacher.jpg" class="img-fluid rounded-circle p-2 rounded-top" alt="Image" style="width: 70px; height: 70px; border-style: dotted; border-color: var(--bs-primary) !important;">
                                </div>
                                <div class="ms-3">
A/B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
...
                        <div class="blog-item rounded-bottom">
                            <div class="blog-img overflow-hidden position-relative img-border-radius">
                                <img src="assets-guest/img/blog-2.jpg" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="d-flex justify-content-between px-4 py-3 bg-light border-bottom border-primary blog-date-comments">
                                <small class="text-dark"><i class="fas fa-calendar me-1 text-dark"></i> 29 Nov 2023</small>
                                <small class="text-dark"><i class="fas fa-comment-alt me-1 text-dark"></i> Comments (15)</small>
...
                            <div class="blog-content d-flex align-items-center px-4 py-3 bg-light">
                                <div class="overflow-hidden rounded-circle rounded-top border border-primary">
content-chunks-idx-3-end
                                    <img src="assets-guest/img/program-teacher.jpg" class="img-fluid rounded-circle p-2 rounded-top" alt="" style="width: 70px; height: 70px; border-style: dotted; border-color: var(--bs-primary) !important;">
                                </div>
                                <div class="ms-3">
A/B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
                                    <h6 class="text-primary">Mary Mordern</h6>
...
                            </div>
                            <div class="px-4 pb-4 bg-light rounded-bottom">
content-chunks-idx-4-start
                                <div class="blog-text-inner">
                                    <a href="#" class="h4">Play outdoor sports with your child</a>
                                    <p class="mt-3 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed purus</p>
                                </div>
                                <div class="text-center">
content-chunks-idx-4-end
                                    <a href="#" class="btn btn-primary text-white px-4 py-2 mb-3 btn-border-radius">View Details</a>
                                </div>
                            </div>
content-chunks-idx-5-start
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="blog-item rounded-bottom">
                            <div class="blog-img overflow-hidden position-relative img-border-radius">
content-chunks-idx-5-end
                                <img src="assets-guest/img/blog-3.jpg" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="d-flex justify-content-between px-4 py-3 bg-light border-bottom border-primary blog-date-comments">
content-chunks-idx-6-start
                                <small class="text-dark"><i class="fas fa-calendar me-1 text-dark"></i> 29 Nov 2023</small>
                        _message_idx_1_rotation_0.1
                            <div class="blog-content d-flex align-items-center px-4 py-3 bg-light">
                                <div class="overflow-hidden rounded-circle rounded-top border border-primary">
...
                                </div>
                            </div>
                content-chunks-idx-6-end
                  <div class="px-4 pb-4 bg-light rounded-bottom">
                                <div class="blog-text-inner">
                                    <a href="#" class="h4">How to make time for your kids?</a>
content-chunks-idx-7-start
                                    <p class="mt-3 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed purus</p>
                                </div>
                                <div class="text-center">
                                    <a href="#" class="btn btn-primary text-white px-4 py-2 mb-3 btn-border-radius">View Details</a>
...
                                    <img src="assets-guest/img/testimonial-2.jpg" class="rounded-circle p-2" style="width: 80px; height: 80px; border-style: dotted; border-color: var(--bs-primary);" alt="">
                                </div>
                                <div class="ms-4">
...
                                    <p class="m-0 pb-3">Profession</p>
                                    <div class="d-flex pe-5">
content-chunks-idx-10-end
                                        <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
                                      content-chunks-idx-11-start
  <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
                                    </div>
...
                                    <h4 class="text-dark">Client Name</h4>
                                    <p class="m-0 pb-3">Profession</p>
content-chunks-idx-11-end
                                    <div class="d-flex pe-5">
                                        <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
                                        <i class="fas fa-star text-primary"></i>
content-chunks-idx-12-start
                                        <i class="fas fa-star text-primary"></i>
                                    </div>
                                </div>
                            </div>
...
content-chunks-idx-15-start
                            <div class="row g-3">
                                <div class="col-4">
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-1.jpg" class="img-fluid rounded-circle p-2" alt="">
                                    </div>
                    section-7
                        <div class="col-4">
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-2.jpg" class="img-fluid rounded-circle p-2" alt="">
content-chunks-idx-15-end
                                    </div>
                               </div>
                                <div class="col-4">
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-3.jpg" class="img-fluid rounded-circle p-2" alt="">
A/B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
                                    </div>
                               </div>
                                <div class="col-4">
i-idx-16-start
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-4.jpg" class="img-fluid rounded-circle p-2" alt="">
                                    </div>
                               </div>
                                <div class="col-4">
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-5.jpg" class="img-fluid rounded-circle p-2" alt="">
                                    </div>
                    section-7
                        <div class="col-4">
                                    <div class="footer-galary-img rounded-circle border border-primary">
                                        <img src="assets-guest/img/galary-6.jpg" class="img-fluid rounded-circle p-2" alt="">
content-chunks-idx-16-end
action-1
                                    </div>
                               </div>
                            </div>
                        </div>
                    </div>
  B test: `assets-guest/` prefix. user's request: `../../css` -> `assets-guest`. The user's request is specific but doesn't match the content. Prepending `assets-guest/` to all local asset paths (`lib/`, `css/`, `js/`, `img/`) is the most helpful interpretation of the user's likely *intent* to move assets into a container folder.
                </div>
            </div>
        </div>
...
    <script src="assets-guest/lib/wow/wow.min.js"></script>
    <script src="assets-guest/lib/easing/easing.min.js"></script>
section-7
    <script src="assets-guest/lib/waypoints/waypoints.min.js"></script>
    <script src="assets-guest/lib/lightbox/js/lightbox.min.js"></script>
    <script src="assets-guest/lib/owlcarousel/owl.carousel.min.js"></script>
